...
### Authoring API skills

If your skill calls an external HTTPS API, read [docs/skill-patterns-v2.md](docs/skill-patterns-v2.md) before writing any code. It covers the host/container split, the OneCLI credential pattern, the container MCP tool layout, and the v1 patterns that no longer apply.
