...
def main() -> int:
    print("Reading credentials from env vars or Keychain...")
    try:
        client_id = os.environ.get("SPOTIFY_CLIENT_ID") or keychain_get("spotify-client-id")
        client_secret = os.environ.get("SPOTIFY_CLIENT_SECRET") or keychain_get("spotify-client-secret")
