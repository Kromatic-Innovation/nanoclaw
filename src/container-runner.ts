...
function buildVolumeMounts(
  ...
  fs.mkdirSync(path.join(groupIpcDir, 'drive', 'requests'), {
    recursive: true,
  });
  fs.mkdirSync(path.join(groupIpcDir, 'drive', 'responses'), {
    recursive: true,
  });
  ...
  fs.mkdirSync(path.join(groupIpcDir, 'docs', 'requests'), {
    recursive: true,
  });
  fs.mkdirSync(path.join(groupIpcDir, 'docs', 'responses'), {
    recursive: true,
  });
